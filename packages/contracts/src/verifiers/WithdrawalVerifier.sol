...
contract PlonkVerifier {
    ...
    uint256 constant Qmx  = 5385136720931958217776113666040329856072099239862908007912479730191369912972;
    uint256 constant Qmy  = 413682756993814415604125294610832050451492708826907323710720893590795748329;
    uint256 constant Qlx  = 8755432947573925641073963191467730258139043701781941900213560371777630151281;
    uint256 constant Qly  = 18483547214573294754411560383163968562590145139134335832417323108185611210004;
    uint256 constant Qrx  = 15475760097153231531779559473510765916608048916040797612899621728611213294631;
    uint256 constant Qry  = 11340027716202733108703825528564743124738523382509885212733120734676471039720;
    uint256 constant Qox  = 11993046891180075011356547868149333438261661410592034446994277041989329041518;
    uint256 constant Qoy  = 21100056858968026984741888851900374408789652560968912433248748347064253397119;
    uint256 constant Qcx  = 4781214444954165286039786977660272083398223779318825056239980368083033621968;
    uint256 constant Qcy  = 13114727900293011419318648424746411812921448985533225645865990712199323112552;
    uint256 constant S1x  = 15426089386208438520743080872112521326944945559773556775559551796000650858457;
    uint256 constant S1y  = 10752997425658365674263056427835166236082460408986577259434318206213134772388;
    uint256 constant S2x  = 5883681663458461488439832817318453219647617384159500724494905855540663916928;
    uint256 constant S2y  = 15270916908911975815354516208004777090091295827306233541209165027802992610581;
    uint256 constant S3x  = 12292767670385179703806748358515830823937329146052571932831595609318693204243;
    uint256 constant S3y  = 12235605075233592311080312807563011141348703819691465269440573745853893279856;
    ...
    function verifyProof(bytes calldata _proof, uint256[4] calldata _pubSignals) public view returns (bool) {
        assembly {
            /////////
